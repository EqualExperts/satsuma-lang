...
See [archive/features/45-agent-reference-progressive-disclosure/PRD.md](../archive/features/45-agent-reference-progressive-disclosure/PRD.md) for what these figures replace and why they're measured rather than estimated.
